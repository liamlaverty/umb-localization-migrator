/** 
* Origin File: https://github.com/umbraco/Umbraco-CMS/tree/v13/contrib/src/Umbraco.Core/EmbeddedResources/Lang/en_us.xml 
...
export default{
	...
	contentPicker: {
		...
		defineXPathOrigin: "Specify root via XPath",
		defineDynamicRoot: "Specify a Dynamic Root",
		configurationStartNodeTitle: "Start node",
		configurationXPathTitle: "XPath Query",
	},
	dynamicRoot: {
	...
	contentTypeEditor: {
		...
		compositionsDescription: "Inherit tabs and properties from an existing Content Type. New tabs will be\n      added to the current Content Type or merged if a tab with an identical name exists.\n    ",
	...
	webhooks: {
		...
		toggleDebug: "Toggle debug mode for more information.",
		statusNotOk: "Not OK status code",
