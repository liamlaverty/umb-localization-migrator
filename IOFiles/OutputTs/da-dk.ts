/** 
* Origin File: https://github.com/umbraco/Umbraco-CMS/tree/v13/contrib/src/Umbraco.Core/EmbeddedResources/Lang/da.xml 
...
export default{
	actions: {
		...
		delete: "Slet",
		disable: "Deaktivér",
		editSettings: "Redigér indstillinger",
		...
		toggleHideUnavailable: "Skjul utilgængelige kompositioner",
	},
	actionCategories: {
		content: "Indhold",
	...
	actionDescriptions: {
		...
		notify: "Tillad adgang til at oprette notifikationer for noder",
	},
	apps: {
		umbContent: "Indhold",
		umbInfo: "Info",
	...
	assignDomain: {
		...
		inherit: "Nedarv",
		setLanguage: "Sprog",
		setLanguageHelp: "Indstil sproget for noder under den aktuelle node,<br /> eller nedarv sprog fra forældernoder. Gælder også<br />\n      for den aktuelle node, medmindre et domæne nedenfor også indstiller et sprog.",
		setDomains: "Domæner",
	},
	buttons: {
		...
		morePublishingOptions: "Flere publiceringsmuligheder",
		submitChanges: "Indsæt",
	},
	auditTrailsMedia: {
		delete: "Brugeren har slettet medie",
		move: "Brugeren har flyttet medie",
		copy: "Brugeren har kopieret medie",
		save: "Brugeren har gemt medie",
	},
	auditTrails: {
		atViewingFor: "For",
	...
	content: {
		...
		routeErrorCannotRoute: "Dette dokument er udgivet, men dets URL kan ikke genereres",
		publish: "Udgiv",
		published: "Udgivet",
		publishedPendingChanges: "Udgivet (Ventede ændringer)",
		publishStatus: "Udgivelsesstatus",
		publishDescendantsHelp: "Klik <em>Udgiv med undersider</em> for at udgive <strong>%0%</strong> og alle sider under, og dermed gøre deres indhold offentligt tilgængeligt.",
		publishDescendantsWithVariantsHelp: "Klik <em>Udgiv med undersider</em> for at udgive <strong>de valgte sprog</strong> og de samme sprog for sider under, og dermed gøre deres indhold offentligt tilgængeligt.",
		...
		sortHelp: "For at sortere, træk siderne eller klik på en af kolonneoverskrifterne. Du kan vælge flere sider\n      ved at holde \"shift\" eller \"control\" nede mens du vælger.\n    ",
	...
	media: {
		...
		maxFileSize: "Maksimal filstørrelse er",
		mediaRoot: "Medie rod",
		moveToSameFolderFailed: "Overordnet og destinationsmappe kan ikke være den samme",
		createFolderFailed: "Oprettelse af mappen under node med id %0% fejlede",
	...
	member: {
		...
		memberGroupNoProperties: "Medlemsgrupper har ingen yderligere egenskaber til redigering.",
	...
	mediaType: {
		...
		autoPickMediaType: "Vælg automatisk",
	},
	memberType: {
	...
	create: {
		...
		noDocumentTypes: "Der kunne ikke findes nogen tilladte dokumenttyper. Du skal tillade disse i <strong>Indstillinger</strong> under <strong>\"Dokumenttyper\"</strong>.",
		noDocumentTypesAtRoot: "Der er ingen dokumenttyper tilgængelige til at oprette indhold her. Du skal oprette disse under <strong>Dokumenttyper</strong> i <strong>Indstillinger</strong>-sektionen.",
		...
		noDocumentTypesAllowedAtRoot: "Der er ingen tilladte Dokumenttyper tilgængelige for at lave indhold her. Du skal tillade dette i <strong>Dokumenttyper</strong> inde i <strong>Indstillinger</strong> sektionen, ved at ændre <strong>Tillad på rodniveau</strong> indstillingen under <strong>Permissions</strong>.",
		noMediaTypes: "Der kunne ikke findes nogen tilladte media typer. Du skal tillade disse i indstillinger under <strong>\"Medietyper\"</strong>.",
	...
	prompt: {
		...
		confirmUnpublish: "Afpublicering vil fjerne denne side og alle dens undersider fra websitet.",
	...
	webhooks: {
		...
		addDocumentType: "Tilføj dokument type",
		addMediaType: "Tilføj medie Type",
		createHeader: "Opret header",
		deliveries: "Leverancer",
		noHeaders: "Der er ikke tilføjet nogen webhook headers",
		toggleDebug: "Skift til debug mode for mere information.",
		statusNotOk: "Ikke OK status kode.",
	},
	language: {
	...
	notifications: {
		editNotifications: "Vælg dine notifikationer for <strong>%0%</strong>",
		notificationsSavedFor: "Notifikationer er gemt for",
	...
	contentPicker: {
		...
		specifyPickerRootTitle: "Afgræns udgangspunktet",
		defineRootNode: "Vælg udgangspunkt",
		defineXPathOrigin: "Definer med XPath",
	...
	contentTypeEditor: {
		...
		compositionsDescription: "Nedarv faner og egenskaber fra en anden indholdstype. Nye faner vil blive\n      tilføjet den nuværende indholdstype eller sammenflettet hvis fanenavnene er ens.\n    ",
	...
	user: {
		...
		sortCreateDateAscending: "Ældste",
		sortCreateDateDescending: "Nyeste",
	...
	visuallyHiddenTexts: {
		...
		openCloseBackofficeProfileOptions: "Åben/luk dine profilindstillinger",
		...
		openContextMenu: "Åben kontekstmenu for",
		...
		userGroupSearchLabel: "Søg i brugergruppesektionen",
		userSearchLabel: "Søg i brugersektionen",
	...
	references: {
		tabName: "Referencer",
		DataTypeNoReferences: "Denne Datatype har ingen referencer.",
		labelUsedByMediaTypes: "Bruges i Medietyper",
		labelUsedByMemberTypes: "Bruges i Medlemstyper",
		usedByProperties: "Bruges af",
		labelUsedByDocuments: "Bruges i Dokumenter",
		labelUsedByMembers: "Bruges i Medlemmer",
		labelUsedByMedia: "Bruges i Medier",
	},
	logViewer: {
		...
		findLogsWithMachineName: "Find logs med maskinnavn",
		open: "Åben",
		polling: "Henter",
	...
	blockEditor: {
		...
		labelCustomViewDescription: "Overskriv hvordan denne blok præsenteres i backoffice. Vælg en\n      .html fil der indeholder din visning.\n    ",
		labelSettingsElementType: "Indstillings model",
		labelEditorSize: "Redigeringsvinduets størrelse",
		...
		girdInlineEditingHelp: "Tilføjer direkte redigering af det første felt. Yderligere felter optræder kun i redigerings vinduet.",
		...
		allowedBlockColumnsHelp: "Vælg de forskellige antal kolonner denne blok må optage i layoutet. Dette forhindrer ikke blokken i at optræde i et mindre område.",
		allowedBlockRows: "Tilgængelige række-størrelser",
		allowedBlockRowsHelp: "Vælg hvor mange rækker denne blok må optage i layoutet.",
		...
		areaAliasHelp: "Dette alias skrives ud via GetBlockGridHTML(), brug aliaset til at fange det element der repræsenterer dette område. F.eks.. .umb-block-grid__area[data-area-alias=\"MitOmraadeAlias\"] { ... }",
		scaleHandlerButtonTitle: "Træk for at skalere",
		areaCreateLabelTitle: "Tilføj indhold label",
		areaCreateLabelHelp: "Overskriv labelen for tilføj indholds knappen i dette område.",
		...
		getSampleDescription: "Dette tilføjer en basal opsætning og hjælper dig til at komme igang med Block Grid Editor.<br/>Dette indeholder Blokke for Overskrift, Formateret Tekst, Billede og To-Kolonners-Layout.",
		...
		addColumnSpanOption: "Tilføj mulighed for %0% kolonner",
		insertBlock: "Indsæt Blok",
		labelInlineMode: "Vis på linje med tekst",
	},
	...
	preview: {
		...
		returnToPreviewDescription: "Du har afsluttet forhåndsvisning, vil du starte forhåndsvisning igen for at\n      se seneste gemte version af indholdet?\n    ",
		returnToPreviewDeclineButton: "Se udgivet indhold",
		viewPublishedContentHeadline: "Se udgivet indhold?",
		viewPublishedContentDescription: "Du er i forhåndsvisning, vil du afslutte for at se den udgivne\n      version?\n    ",
	...
	permissions: {
		...
		MediaFolderCreation: "Mediemappeoprettelse",
	},
	treeSearch: {
