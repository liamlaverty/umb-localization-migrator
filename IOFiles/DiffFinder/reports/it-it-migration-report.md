# Localization migration report for it-it

## Properties in V13 but not in V14

- actions.SetPermissionsForThePage
- buttons.saveAndSchedule
- buttons.showPage
- buttons.rollback
- buttons.submitChangesAndClose
- auditTrailsMedia
- auditTrailsMedia.delete
- auditTrailsMedia.move
- auditTrailsMedia.copy
- auditTrailsMedia.save
- codefile.createFolderFailedById
- codefile.createFolderFailedByName
- content.languagesToPublishForFirstTime
- content.languagesToSave
- content.languagesToSaveForFirstTime
- content.publishedLanguages
- content.unpublishedLanguages
- content.unmodifiedLanguages
- content.untouchedLanguagesForFirstTime
- content.variantsToSendForApproval
- content.variantsToSchedule
- content.variantsToUnpublish
- media.dragFilesHereToUpload
- media.moveFailed
- media.copyFailed
- defaultdialogs.confirmremovereferenceto
- defaultdialogs.macroContainerSettings
- editdatatype.allPropTypes
- editdatatype.willBeDeleted
- editdatatype.yesDelete
- editdatatype.andAllRelated
- general.includeFromsubFolders
- general.installing
- shortcuts.toggleAllowSegmentVariants
- login.bottomText
...
- packager.dropHere
- packager.orClickHereToUpload
- packager.uploadPackage
- packager.localPackageDescription
- packager.uploadAnother
- packager.cancelAndUploadAnother
- packager.accept
- packager.termsOfUse
- packager.pathToFile
- packager.pathToFileDescription
- packager.installLocal
- packager.installFinish
- packager.packageActions
- packager.packageAuthorUrl
- packager.packageFiles
- packager.packageIconUrl
- packager.packageInstall
- packager.packageLicenseUrl
- packager.packageProperties
- packager.packageVersionUpgrade
- packager.packageAlreadyInstalled
- packager.targetVersionMismatch
- packager.installStateUninstalling
- packager.installStateDownloading
- packager.installStateImporting
- packager.installStateInstalling
- packager.installStateRestarting
- packager.installStateComplete
- packager.installStateCompleted
- packager.installStateUploading
- mediaPicker.resetMediaCrop
- mediaPicker.confirmRemoveMediaEntryMessage
- imagecropper.saveCrop
- imagecropper.addCrop
- speechBubbles.editMemberGroupSaved
- template.copyToClipboard
- grid.placeholderImageCaption
- contentTypeEditor.allowAsRootHeading
- contentTypeEditor.allowAsRootDescription
- templateEditor.addFallbackField
- templateEditor.fallbackField
- templateEditor.convertLineBreaksDescription
- templateEditor.formatAndEncoding
- templateEditor.formatAsDateDescr
- templateEditor.modifyOutput
- templateEditor.separator
- translation.mailBody
- user.selectUserGroups
- user.inviteEmailCopySubject
- user.inviteEmailCopyFormat
- user.invite
- healthcheck.rectifySuccessMessage
- healthcheck.customErrorsCheckSuccessMessage
- healthcheck.customErrorsCheckErrorMessage
- healthcheck.customErrorsCheckRectifySuccessMessage
- healthcheck.macroErrorModeCheckRectifySuccessMessage
- healthcheck.trySkipIisCustomErrorsCheckSuccessMessage
- healthcheck.trySkipIisCustomErrorsCheckErrorMessage
- healthcheck.trySkipIisCustomErrorsCheckRectifySuccessMessage
- healthcheck.configurationServiceFileNotFound
- healthcheck.configurationServiceNodeNotFound
- healthcheck.configurationServiceError
- healthcheck.databaseSchemaValidationCheckDatabaseOk
- healthcheck.databaseSchemaValidationCheckDatabaseErrors
- healthcheck.databaseSchemaValidationCheckDatabaseLogMessage
- healthcheck.httpsCheckEnableHttpsError
- healthcheck.httpsCheckEnableHttpsButton
- healthcheck.httpsCheckEnableHttpsDescription
- healthcheck.httpsCheckEnableHttpsSuccess
- healthcheck.rectifyButton
- healthcheck.cannotRectifyShouldNotEqual
- healthcheck.cannotRectifyShouldEqualWithValue
- healthcheck.valueToRectifyNotProvided
- healthcheck.compilationDebugCheckRectifySuccessMessage
- healthcheck.traceModeCheckSuccessMessage
- healthcheck.traceModeCheckErrorMessage
- healthcheck.traceModeCheckRectifySuccessMessage
- healthcheck.folderPermissionsCheckMessage
- healthcheck.requiredFolderPermissionFailed
- healthcheck.optionalFolderPermissionFailed
- healthcheck.filePermissionsCheckMessage
- healthcheck.requiredFilePermissionFailed
- healthcheck.optionalFilePermissionFailed
- healthcheck.setHeaderInConfig
- healthcheck.clickJackingSetHeaderInConfigDescription
- healthcheck.clickJackingSetHeaderInConfigSuccess
- healthcheck.setHeaderInConfigError
- healthcheck.noSniffSetHeaderInConfigDescription
- healthcheck.noSniffSetHeaderInConfigSuccess
- healthcheck.hSTSSetHeaderInConfigDescription
- healthcheck.hSTSSetHeaderInConfigSuccess
- healthcheck.xssProtectionSetHeaderInConfigDescription
- healthcheck.xssProtectionSetHeaderInConfigSuccess
- healthcheck.scheduledHealthCheckEmailBody
- healthcheck.scheduledHealthCheckEmailSubject
- healthcheck.checkAllGroups
- redirectUrls.confirmRemove
- references.noDocumentTypes
- references.noMediaTypes
- references.noMemberTypes
...
- blockEditor.labelTemplatePlaceholder
